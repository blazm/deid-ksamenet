...
from keras.layers import merge, Merge, Dropout, Input, Activation
from keras.regularizers import l2, l1
#from keras.utils.visualize_util import plot # keras 1.2
from keras.utils.vis_utils import plot_model as plot # keras 2.0
